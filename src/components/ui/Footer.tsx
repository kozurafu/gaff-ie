  ...
  const FooterLink = ({ href, children }: { href: string; children: React.ReactNode }) => {
    ...
    return (
      <li className="flex items-center gap-2">
        <span className="text-gray-600 cursor-default">{children}</span>
        <span className="text-[10px] font-medium text-gray-600 bg-gray-800 px-1.5 py-0.5 rounded-full">Soon</span>
      </li>
    );
  };

  return (
    <footer className="bg-gaff-slate text-gray-400">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              {['twitter', 'instagram', 'linkedin'].map((s) => (
                <span key={s} className="w-9 h-9 rounded-full bg-gray-800 flex items-center justify-center text-gray-500 hover:bg-gaff-teal hover:text-white transition-colors cursor-pointer">
          ...
          <div>
            <h4 className="text-white font-semibold text-sm mb-4 uppercase tracking-wider">For Tenants</h4>
          ...
          <div>
            <h4 className="text-white font-semibold text-sm mb-4 uppercase tracking-wider">For Landlords</h4>
            <ul className="text-sm space-y-3">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-600">
